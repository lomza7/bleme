  ...
  return (
    <div className="flex flex-1 flex-col justify-center">
      <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
        {isUnpaid
          ? "Les faits, en 30 secondes."
          : isAdmin
            ? "La démarche, en 30 secondes."
            : "Le litige, en 30 secondes."}
      </h1>
        ...
        <Field
          label={
            isUnpaid
              ...
              : isAdmin
                ? "Quelle administration ou quel service ?"
                : "Avec qui avez-vous ce litige ?"
          }
          light={light}
        >
          {isAdmin ? (
